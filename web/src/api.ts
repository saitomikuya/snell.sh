...
export interface AnyConnectUserTraffic { userId:string; period:string; uploadBytes:number; downloadBytes:number; quotaBytes:number; resetDay:number; paused:boolean; pausedByQuota:boolean; updatedAt:string }
