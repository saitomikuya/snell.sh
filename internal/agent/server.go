...
func (s *RuntimeService) SampleAnyConnectTraffic(_ Empty, out *Result) error {
	err := s.Manager.SampleAnyConnectTraffic()
	out.OK = err == nil
	if err != nil {
		out.Message = err.Error()
		return err
	}
	out.Message = "AnyConnect user traffic sampled"
	return nil
}
